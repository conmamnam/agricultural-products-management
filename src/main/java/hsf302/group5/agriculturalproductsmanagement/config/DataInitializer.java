...
//import hsf302.group5.agriculturalproductsmanagement.repository.*;
...
//        Category comboMix = new Category("Combo / Hộp quà trái cây"); // Combo
//
//        categoryRepository.saveAll(List.of(berry, citrus, stoneFruit, melon, tropical, pome, exotic, comboMix));
//
//
//        // ------------------- Product list -------------------
//
...
//
//        // Quả có múi
//        Product quyt = new Product(
//                "Quýt Úc",
//                "Quýt Úc túi 500g",
//                39000,
//                10,
//                "https://cdnv2.tgdd.vn/bhx-static/bhx/Products/Images/8788/223036/bhx/quyt-mini-tui-500g_202502201329369642.jpg",
//                citrus
//        );
//
//
...
//        );
//
//        Product hopQuaHT134 = new Product(
//                "Hộp quà trái cây HT134",
//                "Hộp quà trái cây gồm: Nho Mẫu Đơn 1kg, Quýt Úc 1kg, Táo Nam Phi 1kg (mix 3 loại)",
//                600000,
//                3,
//                "https://tamfruit.vn/wp-content/uploads/2024/07/hop-trai-cay-qua-tang.jpg",
//                comboMix
//        );
//        ProductComboItem item1HT134 = new ProductComboItem(hopQuaHT134, nho, 2);
//        ProductComboItem item2HT134 = new ProductComboItem(hopQuaHT134, quyt, 2);
//        ProductComboItem item3HT134 = new ProductComboItem(hopQuaHT134, tao, 1);
//
//
//        // Save all products
...
//        ));
//
//        // Save all product combo
//        productComboItemRepository.saveAll(List.of(
//                item1HT134, item2HT134, item3HT134
//        ));
//
//    }
//}
